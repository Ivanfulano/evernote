package com.bq.ivan.bqevernote.io;
...
public class FindNotesTask extends BaseTask<List<NoteRef>> {
    ...
    public FindNotesTask(int offset, int maxNotes, @Nullable Notebook notebook, @Nullable LinkedNotebook linkedNotebook, @Nullable String query, int sortOrder) {
        super((Class) List.class);

        NoteFilter noteFilter = new NoteFilter();
        noteFilter.setOrder(sortOrder);
